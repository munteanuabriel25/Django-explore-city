...
urlpatterns =[
    ...
    path('blog/<int:pk>/', PostListingApiView.as_view(), name='api-post-list'),
    ...
    path('listing-categ/action/', ListingWishListAPIView.as_view(), name="wishlist-action"),
]